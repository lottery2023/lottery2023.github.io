...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["views-finance-finance-module"], {
  ...
  /***/
  function srcAppViewsFinanceFinanceRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppViewsFinanceFinanceModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _finance_routing_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    ...
    FinanceModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      ...
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _finance_routing_module__WEBPACK_IMPORTED_MODULE_2__["FinanceRoutingModule"], _demo_material_module__WEBPACK_IMPORTED_MODULE_3__["DemoMaterialModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["ReactiveFormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"]]]
    });
  ...
  /***/
  function srcAppViewsFinanceSalesSalesComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    function SalesComponent_mat_card_header_3_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function SalesComponent_ng_container_24_th_1_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "th", 21);
    ...
    function SalesComponent_ng_container_24_td_2_button_3_Template(rf, ctx) {
      if (rf & 1) {
        var _r19 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "button", 27);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function SalesComponent_ng_container_24_td_2_button_3_Template_button_click_0_listener() {
          ...
          return ctx_r17.onEdit(element_r14);
        });
    ...
    function SalesComponent_ng_container_24_td_2_button_4_Template(rf, ctx) {
      if (rf & 1) {
        var _r22 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "button", 28);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function SalesComponent_ng_container_24_td_2_button_4_Template_button_click_0_listener() {
          ...
          return ctx_r20.onDelete(element_r14);
        });
    ...
    function SalesComponent_ng_container_24_td_2_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "td", 22);
    ...
    function SalesComponent_ng_container_24_td_3_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function SalesComponent_ng_container_24_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function SalesComponent_tr_25_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "tr", 30);
      }
    }

    function SalesComponent_tr_26_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "tr", 31);
      }
    }

    function SalesComponent_tr_27_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "tr", 32);
      }
    }

    var SalesComponent = /*#__PURE__*/function (_baseSearchView__WEBP) {
      _inherits(SalesComponent, _baseSearchView__WEBP);

      var _super = _createSuper(SalesComponent);

      function SalesComponent(service, authService, router) {
        var _this;
        ...
        _this.displayedColumns = ['employeeCode', 'valor'];
        _this.filtersColumns = ['employeeCode'];
      ...
      _createClass(SalesComponent, [{
        ...
        value: function ngOnInit() {
          ...
          _get(_getPrototypeOf(SalesComponent.prototype), "init", this).call(this, this);

          _get(_getPrototypeOf(SalesComponent.prototype), "onPageChange", this).call(this);
        }
      }, {
        key: "ngOnChanges",
        ...
        value: function getText(element) {
          if (element == 'employeeCode') {
            ...
            if (this.dataSource && this.dataSource.data) {
              return this.dataSource.data.reduce(function (accum, curr) {
    ...
    SalesComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function SalesComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("keyup.enter", function SalesComponent_Template_input_keyup_enter_8_listener() {
            return ctx.onPageChange();
          })("ngModelChange", function SalesComponent_Template_input_ngModelChange_8_listener($event) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function SalesComponent_Template_input_ngModelChange_12_listener($event) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function SalesComponent_Template_button_click_18_listener() {
            return ctx.onPageChange();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("matSortChange", function SalesComponent_Template_table_matSortChange_20_listener($event) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("page", function SalesComponent_Template_mat_paginator_page_28_listener($event) {
...
//# sourceMappingURL=views-finance-finance-module-es5.js.map